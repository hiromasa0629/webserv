...
#    Updated: 2023/02/14 18:19:36 by hyap             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME		= main
SRCSDIR		= srcs
SRCS		= $(wildcard $(SRCSDIR)/*.cpp) $(wildcard $(SRCSDIR)/config/*.cpp) $(wildcard $(SRCSDIR)/utils/*.cpp) $(wildcard $(SRCSDIR)/socket/*.cpp) $(wildcard $(SRCSDIR)/server/*.cpp)
OBJSDIR		= srcs/obj
OBJS 		= $(SRCS:%.cpp=%.o)
